module.exports = {
  ...
  mergeConfig(data, defaults) {
    return {
      ...
      isAny: data.isAny !== undefined ? data.isAny : defaults.isAny,
      ...
      isFilterFormat: data.isFilterFormat !== undefined ? data.isFilterFormat : defaults.isFilterFormat,
      ...
      isNewFormat: data.isNewFormat !== undefined ? data.isNewFormat : defaults.isNewFormat,
